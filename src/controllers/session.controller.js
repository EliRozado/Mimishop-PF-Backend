...
class SessionController{
    async login(req, res){
        try{
            ...
            const token = jwt.sign({email, first_name: user.user.first_name, last_name: user.user.last_name, role: user.user.role, user_id: user.user.id, cart: user.cart}, 'pageSecret', { expiresIn: '10m' });
